...
class _PreApproveCabState extends State<PreApproveCab> {
  ...
  Widget _buildCompanyItem({
    ...
    return GestureDetector(
      onTap: () => setState(() => selectedCompany = index),
      child: Column(
        children: [
          Container(
            width: 64,
  ...
  Widget _buildCarNumberField() {
    return PinCodeTextField(
      ...
      onChanged: (value) => setState(() => carNumber = value),
      onCompleted: (value) => debugPrint('Car Number Completed: $value'),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Pre Approve Cab', style: TextStyle(fontSize: 18)),
        elevation: 0,
                ...
                Row(
                  children: [
                    Checkbox(
                      value: longHourVisit,
                      onChanged:
                          (val) => setState(() => longHourVisit = val ?? false),
                      activeColor: Colors.green,
