...
class _PreApproveDeliveryState extends State<PreApproveDelivery> {
  ...
  Widget _buildDayToggle(String text, int value) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Text(
          text,
          style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: isSelected ? Colors.white : Colors.grey),
        ),
      ),
    );
  }
  ...
  Widget _buildDatePickerButton() {
    return GestureDetector(
      onTap: () async {
        ...
        DateTime firstDate = selectedDay == 0 ? DateTime.now() : DateTime.now().add(const Duration(days: 1));
      ...
      child: Container(
        ...
        child: Text(
          selectedDate == null ? 'Pick a date' : '${selectedDate!.day}-${selectedDate!.month}-${selectedDate!.year}',
          ...
          children: [
            if (withIcon)
              Padding(
                ...
                child: Image.asset('assets/images/icons/clock.png', width: 16, height: 16),
              ),
            Text(
              text,
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: isSelected ? Colors.green : Colors.grey),
            ),
          ],
        ),
      ),
  ...
  Widget _buildCompanyItem({required int index, required String asset, required String name}) {
    ...
    return GestureDetector(
      ...
      child: Column(
        children: [
          ...
          Text(name, style: TextStyle(fontSize: 12, color: Colors.grey.shade700, fontWeight: FontWeight.w500))
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Pre Approve Delivery', style: TextStyle(fontSize: 18)),
        elevation: 0,
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Row(children: [
              ...
              const Text('Anytime in Day hours', style: TextStyle(fontSize: 14, color: Colors.black)),
            ]),
          ]),
          ...
          Container(
            ...
            child: Column(children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                const Text('Time',
                    style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.black)),
                const Text('(The gate will expire after 2 hours)',
                    style: TextStyle(fontSize: 12, color: Colors.grey)),
              ]),
              const SizedBox(height: 12),
              Column(
                children: [
                  Center(child: _buildTimeButton('10:30-11:00 AM', 0, withIcon: true)),
                  const SizedBox(height: 12),
                  Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          ...
          Row(children: [
            Checkbox(
                ...
                activeColor: Colors.green,
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(4))),
            const Text('Collect My Parcels at the gate only',
